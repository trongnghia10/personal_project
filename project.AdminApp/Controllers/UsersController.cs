...
namespace project.AdminApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,roleId,fullname,email,phoneNumber,address,username,password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,roleId,fullname,email,phoneNumber,address,username,password")] User user)
        {
            if (id != user.id)
            {
                return NotFound();
